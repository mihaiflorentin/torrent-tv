...
describe('nearEnd', () => {
  it('is true within the lookahead window of the end', () => {
    expect(nearEnd(20, 24)).toBe(true);
    expect(nearEnd(23, 24)).toBe(true);
  });
  it('is false away from the end or for an empty list', () => {
    expect(nearEnd(19, 24)).toBe(false);
