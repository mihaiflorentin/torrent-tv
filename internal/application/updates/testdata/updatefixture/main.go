...
func (s fixtureSource) LatestRelease(context.Context) (updates.Release, error) {
	return updates.Release{
		Tag: "v" + s.sel.Version,
		URL: "https://github.com/mihaiflorentin/torrent-tv/releases/tag/v" + s.sel.Version,
		Assets: []updates.Asset{
			{Name: s.sel.AssetName, URL: "https://github.com/mihaiflorentin/torrent-tv/releases/download/v" + s.sel.Version + "/" + s.sel.AssetName},
			{Name: "SHA256SUMS", URL: "https://github.com/mihaiflorentin/torrent-tv/releases/download/v" + s.sel.Version + "/SHA256SUMS"},
		},
	}, nil
}
